...
export default function Cadastrar({ navigation }) {
    ...
    async function realizarCadastro() {
        if (nome ==''){
            setMensagemError('O nome  não pode ficar vazio!')
            setStatusError('nome')
        }
        else if (email == '') {
            ...
            setMensagemError('Telefone não pode ficar vazio!')
    ...
    return (
        <View style={estilos.container}>
            ...
            <TextInput
                ...
                style={estilos.input} />
            {statusError == 'telefone' ? <HelperText type="error" visible={statusError == 'telefone'}>
                {mensagemError}
            </HelperText> : null}
